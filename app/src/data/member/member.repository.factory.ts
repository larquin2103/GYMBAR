 ...
 * usa Firestore; sin credenciales (dev/demo) usa el repo en memoria con datos de
 * ejemplo. La UI depende solo de la interfaz, nunca de esta elección.
 */
export function getMemberRepository(): MemberRepository {
  ...
  instance = isFirebaseConfigured
    ...
    : new InMemoryMemberRepository(memberSeed);
  return instance;
}
